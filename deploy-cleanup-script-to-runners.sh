...
@daily docker system prune -f ; rm -rf /home/gitlab-runner/.cache ; mkdir -p /home/gitlab-runner/.cache/go-build ; chown -R gitlab-runner:gitlab-runner /home/gitlab-runner/ ; journalctl --vacuum-time=10d
EOF
done
