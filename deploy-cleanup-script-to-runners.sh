...
do
    ...
    ssh $SSH_TARGET sudo mkdir -p /home/gitlab-runner/.cache
...
@daily docker system prune -f ; rm -rf /home/gitlab-runner/.cache ; mkdir -p /home/gitlab-runner/.cache ; chown -R gitlab-runner:gitlab-runner /home/gitlab-runner/ ; journalctl --vacuum-time=10d
EOF
done
